const styles = {
    ...
    active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimsom]",
    button: "w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#f63b60] flex item-center justify-center cursor-pointer",
