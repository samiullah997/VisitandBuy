    ...
    <>
      ...
      <div className="career-container p-8">
        ...
        <p className="text-gray-700 mb-6">
          At <span className="text-blue-500">HaramSales</span>, we are always on
        ...
        <p className="text-gray-700 mb-6">
          ...
          opportunities at <span className="text-blue-500">HaramSales</span>. We
        ...
        <p className="text-gray-700 mb-6">
          Joining <span className="text-blue-500">HaramSales</span> means
        ...
        <p className="text-gray-700 mb-6">
          Become a part of <span className="text-blue-500">HaramSales</span> and
