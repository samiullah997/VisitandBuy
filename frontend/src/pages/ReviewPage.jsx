    ...
    <>
      ...
      <div className="review-container p-8">
        ...
        <p className="text-gray-700 mb-6">
          ...
          with <span className="text-blue-500">Visit and Buy</span>. We take pride
        ...
        <div className="review-card mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <span className="text-blue-500">Visit and Buy</span> for years. The
        ...
        <div className="review-card mb-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <span className="text-blue-500">Visit and Buy</span> is truly
        ...
        <div className="review-card mb-6">
          ...
          <p className="text-gray-700 mb-4">
            I can always trust <span className="text-blue-500">Visit and Buy</span>{" "}
        ...
        <div className="review-card">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <span className="text-blue-500">Visit and Buy</span> ensures that I
        ...
        <p className="text-gray-700 mt-6">
          ...
          <span className="text-blue-500">Visit and Buy</span> for your shopping
          needs!
        </p>
      </div>
      <Footer />
