...
router.post("/create-shop", upload.single("file"), async (req, res, next) => {
  try {
    ...
    const activationUrl = `https://visitandbuy.shop/seller/activation/${activationToken}`;
    ...
    try {
      await sendMail({
        ...
        <head>
            ...
            <title>Activate Your Account - ${seller.name}</title>
            <style>
                body {
        ...
        <body>
            ...
            <div class="container">
                <h2>Activate Your Account - ${seller.name}</h2>
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      if(user.status === "Pending") {
        return next(new ErrorHandler("Your account is not activated yet!", 400));
      }
